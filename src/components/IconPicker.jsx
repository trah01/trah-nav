                        ...
                        {filteredIcons.map(iconName => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`aspect-square rounded-lg flex items-center justify-center text-lg hover:bg-blue-50 hover:text-blue-500 transition-colors ${
                                        value === iconName ? 'bg-blue-100 text-blue-600 ring-2 ring-blue-200' : 'text-slate-500'
                                    }`}
                                    title={iconName}
                                >
                                    <Icon size={18} />
